      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          <Link to="/" className="flex items-center gap-3 justify-center mb-10 group">
            <motion.div 
              className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-primary via-primary to-accent flex items-center justify-center shadow-lg"
            ...
            <div className="relative z-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="relative group/input">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <Input
                        ...
                        className="pl-11 h-12 bg-background/50 border-border/50 rounded-xl focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-muted-foreground/40"
                      />
                    </div>
                  </div>
                  {errors.email && (
                ...
                >
                  <Button
                    type="submit"
                    className="w-full h-12 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground font-semibold rounded-xl shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all duration-300 group/btn"
                    disabled={loading}
                  >
                    {loading ? (
        ...
        {/* Trust indicators */}
        <motion.div 
          className="mt-8 flex items-center justify-center gap-6 text-muted-foreground/50"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1 }}
        >
